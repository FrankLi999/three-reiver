	...
	public ConcurrentKafkaListenerContainerFactory<String, String> kafkaListenerContainerFactory() {
		...
		factory.setRecordFilterStrategy(
	        record -> {
	            ...
	            return !(messageType.equals(MessageConstants.TRANSACTION_EVEVT_TYPE) || messageType.endsWith("Event"));
	        });
		return factory;
	}
	
//	@Bean
//	public ConcurrentKafkaListenerContainerFactory<String, String> orderPlacedEventKafkaListenerContainerFactory() {
//		ConcurrentKafkaListenerContainerFactory<String, String> factory = new ConcurrentKafkaListenerContainerFactory<>();
//		factory.setConsumerFactory(consumerFactory());
//		factory.setRecordFilterStrategy(
//	        record -> {
//	        	System.out.println(record);
//	        	return !new String(record.headers().lastHeader("type").value()).equals("OrderPlacedEvent");
//	        });
//		return factory;
//	}
//	
